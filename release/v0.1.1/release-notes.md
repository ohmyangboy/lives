...
线上 DMG 已由 GitHub Actions 的 Apple Silicon macOS runner 重新下载，并通过 SHA-256、磁盘映像、代码签名、三路带音频拼贴渲染、Live Photo 元数据与 JPG/MOV 配对验证。[查看成功运行](https://github.com/ohmyangboy/lives/actions/runs/29900779244)
