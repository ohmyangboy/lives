...
最新正式版：[v0.1.11](https://github.com/ohmyangboy/lives/releases/tag/v0.1.11)。反馈与关于页改为真实设备信息，更新重启后提供反馈入口，并保留照片权限应用内恢复、画布自定义比例与文件夹同步，支持通过应用内自动更新升级。
